...
{
    class CountyReportFactory
    {
        private static CountyReportFactory instance = new CountyReportFactory();
        public static CountyReportFactory Instance
        {
            get { return instance; }
        }

        public List<CountyReport> PopulateCountyReportObjects()
        {
            SWMPDDEntities databaseContext = new SWMPDDEntities();
            List<Client> allCountyReport = (from c in databaseContext.Clients orderby c.County select c).ToList();
